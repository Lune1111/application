...
<!--				<image class="TUI-icon" @tap="switchAudio" :src="isAudio ? '/static/static/assets/keyboard.svg' : '/static/static/assets/audio.svg'"></image>-->
				...
				<view class="TUI-message-input-functions" hover-class="none">
					...
					<view v-else class="TUI-sendMessage-btn" >
						<u-button v-if="!value" @tap="sendTextMessage" shape="circle"
								  style="background-color: #2979ff;color: rgb(255,252,243);height: 30px">发送
						</u-button>
					</view>
				</view>
			</view>
