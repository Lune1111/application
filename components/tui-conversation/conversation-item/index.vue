	...
	<movable-area v-if="conversation.conversationID" class="t-conversation-item-container">
		<movable-view class="t-conversation-item" direction="horizontal" @change="handleTouchMove" damping="100" :x="xScale">
			<view class="avatar-box">
				<uni-view>
					<u-avatar :src="setConversationAvatar"></u-avatar>
				</uni-view>
			...
			<uni-view  class="uni-media-list-body u-p-l-30 u-flex-1">
				<uni-view class="uni-media-list-text-top" style="color: #000000"><span>{{ conversationName }}</span>
				</uni-view>
				<uni-view class="uni-media-list-text-bottom u-type-info-dark u-font-10" >
					<uni-text>{{ conversation.lastMessage.messageForShow }}</uni-text>
				</uni-view>
			</uni-view>
